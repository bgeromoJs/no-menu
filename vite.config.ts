...
export default defineConfig(({ mode }) => {
  // Fixed: Use imported cwd() instead of process.cwd() to resolve typing issues where the global 'process' might be incorrectly typed as a browser Process object.
